...
def preprocess_images(input_face_dir, out_face_dir, out_labels, postfix='jpg'):
...
if __name__ == '__main__':
    ...
    preprocess_images(images_dir, out_face_dir, out_labels, 'jpg')
