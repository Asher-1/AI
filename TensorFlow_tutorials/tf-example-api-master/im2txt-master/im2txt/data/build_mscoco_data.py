...
tf.flags.DEFINE_string("train_image_dir", "images/raw-data/train2014/",
                       "Training image directory.")
tf.flags.DEFINE_string("val_image_dir", "images/raw-data/val2014",
                       "Validation image directory.")

tf.flags.DEFINE_string("train_captions_file", "images/raw-data/annotations/captions_train2014.json",
                       "Training captions JSON file.")
tf.flags.DEFINE_string("val_captions_file", "images/raw-data/annotations/captions_val2014.json",
                       "Validation captions JSON file.")

tf.flags.DEFINE_string("output_dir", "processed_images/", "Output data directory.")
...
tf.flags.DEFINE_string("word_counts_output_file", "processed_images/word_counts.txt",
