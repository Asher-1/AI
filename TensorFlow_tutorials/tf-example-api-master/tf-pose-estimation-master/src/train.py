...
if __name__ == '__main__':
    base_dir = 'G:/develop/PycharmProjects/datasets/coco_data/'

    parser = argparse.ArgumentParser(description='Training codes for Openpose using Tensorflow')
    parser.add_argument('--model', default='mobilenet', help='model name')
    parser.add_argument('--datapath', type=str, default=base_dir + 'annotations')
    parser.add_argument('--imgpath', type=str, default=base_dir)
    parser.add_argument('--batchsize', type=int, default=2)
    parser.add_argument('--gpus', type=int, default=1)
    parser.add_argument('--max-epoch', type=int, default=30)
    parser.add_argument('--lr', type=str, default='0.01')
    parser.add_argument('--modelpath', type=str, default='../data/output_graph/')
    parser.add_argument('--logpath', type=str, default='../data/output_graph/')
    parser.add_argument('--checkpoint', type=str, default='../data/output_graph')
