...
# 识别处理
def process(model, oriImg, params, model_params):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--queue_num', type=int, default=5)
    ...
    while True:
        ...
        if (frame_count % frame_interval) == 0:
            ...
            frame = process(model, frame, params, model_params)
        ...
        cv2.putText(frame,
                    ...
                    (0, 255, 0), 2)
        cv2.imshow('camera_pose-estimation result', frame)
        fps_time = time.time()
