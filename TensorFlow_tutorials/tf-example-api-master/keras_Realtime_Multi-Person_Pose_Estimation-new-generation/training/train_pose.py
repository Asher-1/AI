...
train_client = DataIterator(config, COCOSourceConfig("../../../../datasets/coco_data/coco_train_dataset.h5"), shuffle=True,
                            augment=True, batch_size=batch_size)
val_client = DataIterator(config, COCOSourceConfig("../../../../datasets/coco_data/coco_val_dataset.h5"), shuffle=False, augment=False,
...
if task == "train":
    train(config, model, train_client, val_client, iterations_per_epoch, validation_steps, metrics_id, epoch,
