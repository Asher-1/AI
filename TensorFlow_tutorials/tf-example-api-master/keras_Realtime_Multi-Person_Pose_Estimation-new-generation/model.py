...
def get_training_model(weight_decay, np_branch1, np_branch2, stages=6, gpus=None):
    ...
    if np_branch1 > 0:
        ...
        w1 = apply_mask(stage1_branch1_out, vec_weight_input, heat_weight_input, np_branch1, 1, 1, np_branch1,
                        np_branch2)
        outputs.append(w1)
    ...
    if np_branch2 > 0:
        ...
        w2 = apply_mask(stage1_branch2_out, vec_weight_input, heat_weight_input, np_branch2, 1, 2, np_branch1,
                        np_branch2)
        outputs.append(w2)
    ...
    for sn in range(2, stages + 1):
        ...
        if np_branch1 > 0:
            ...
            w1 = apply_mask(stageT_branch1_out, vec_weight_input, heat_weight_input, np_branch1, sn, 1, np_branch1,
                            np_branch2)
            outputs.append(w1)
        ...
        if np_branch2 > 0:
            ...
            w2 = apply_mask(stageT_branch2_out, vec_weight_input, heat_weight_input, np_branch2, sn, 2, np_branch1,
                            np_branch2)
            outputs.append(w2)
