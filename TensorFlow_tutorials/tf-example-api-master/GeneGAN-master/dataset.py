...
batch_size = 16
m_data_dir = 'G:/develop/PycharmProjects/datasets/CelebA/'
model_graph_output_path = 'G:/develop/PycharmProjects/datasets/result_outputs/GeneGAN_master_output'

class Config:
    def set_model_dir_name(self, dir_name='feature_Bangs'):
        self.model_dir_name = dir_name

    @property
    def base_dir(self):
        # return os.path.abspath(os.curdir)
        return os.path.join(model_graph_output_path, self.model_dir_name)
    @property
    def data_dir(self):
        data_dir = m_data_dir
...
class Dataset(object):
    ...
    def __init__(self, feature, data_dir=config.data_dir, nhwc=config.nhwc, num_threads=config.num_threads,
        ...
        with open(os.path.join(self.data_dir, 'Anno/list_attr_celeba.txt'), 'r') as f:
