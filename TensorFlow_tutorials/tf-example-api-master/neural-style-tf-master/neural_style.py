...
'''
# 用户自定义参数
model_weights = 'G:\develop\PycharmProjects\datasets\VGG_models\imagenet-vgg-verydeep-19.mat'
style_imgs = ['dark_matter_bw.png']
content_img = 'lion.jpg'
output_img_name = 'result2'
...
def build_model(input_img):
    ...
    if not all(i in vgg_rawnet for i in ('layers', 'classes', 'normalization')):
        raise ValueError(
...
if __name__ == '__main__':
    ...
    # 图片融合总时长：596.236712 s --- 9.937279 min
    print('\n图片融合总时长：%f s --- %f min' % (end - start, (end - start) / 60.0))
