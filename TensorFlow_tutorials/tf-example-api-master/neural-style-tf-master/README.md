...
![output](examples/lions/42_output.png)
![output](examples/lions/content_style.png)


Transferring the style of various artworks to the same content image produces qualitatively convincing results:

![output](examples/lions/32_output.png)
![output](examples/lions/styles/matisse_crop.jpg)
![output](examples/lions/33_output.png)
![output](examples/lions/styles/water_lilies_crop.jpg)

![output](examples/lions/wave_output.png)
![output](examples/lions/styles/wave_crop.jpg)
![output](examples/lions/basquiat_output.png)
![output](examples/lions/styles/basquiat_crop.jpg)
![output](examples/lions/calliefink_output.png)
![output](examples/lions/styles/calliefink_crop.jpg)

![output](examples/lions/giger_output.png)
![output](examples/lions/styles/giger_crop.jpg)
...
![output](examples/gatys_figure/tubingen.png)
![output](examples/gatys_figure/tubingen_shipwreck.png)

![output](examples/gatys_figure/tubingen_picasso.png)
![output](examples/gatys_figure/tubingen_scream.png)
![output](examples/gatys_figure/tubingen_kandinsky.png)
...
![output](examples/style_content_tradeoff/okeffe.jpg)
![output](examples/style_content_tradeoff/okeffe_10.png)
![output](examples/style_content_tradeoff/okeffe_100.png)
![output](examples/style_content_tradeoff/okeffe_10000.png)
![output](examples/style_content_tradeoff/output_1000000.png)


### Multiple Style Images
More than one style image can be used to blend multiple artistic styles.

![output](examples/multiple_styles/tubingen_starry_scream.png)
![output](examples/multiple_styles/tubingen_scream_kandinsky.png)
![output](examples/multiple_styles/tubingen_starry_seated.png)
![output](examples/multiple_styles/tubingen_seated_kandinsky.png.png)
![output](examples/multiple_styles/tubingen_afremov_grey.png)
![output](examples/multiple_styles/tubingen_basquiat_nielly.png)
...
![output](image_input/taj_mahal.jpg)
![output](examples/style_interpolation/taj_mahal_scream_2_starry_8.png)
![output](examples/style_interpolation/taj_mahal_scream_8_starry_2.png)
![output](examples/style_interpolation/taj_mahal_afremov_grey_8_2.png)
![output](examples/style_interpolation/taj_mahal_afremov_grey_5_5.png)
![output](examples/style_interpolation/taj_mahal_afremov_grey_2_8.png)
...
![output](examples/original_colors/new_york.png)
![output](examples/original_colors/stylized.png)
![output](examples/original_colors/stylized_original_colors.png)
![output](examples/original_colors/garden.png)
![output](examples/original_colors/garden_starry.png)
![output](examples/original_colors/garden_starry_yuv.png)
...
![output](examples/pareidolic/flowers_output.png)

![output](examples/pareidolic/styles/flowers_crop.jpg)

![output](examples/pareidolic/styles/oil_crop.jpg)

![output](examples/pareidolic/dark_matter_output.png)
![output](examples/pareidolic/styles/dark_matter_bw.png)
![output](examples/pareidolic/ben_giles_output.png)
![output](examples/pareidolic/styles/ben_giles.png)
...
![output](examples/segmentation/00110.jpg)
![output](examples/segmentation/00110_mask.png)
![output](examples/segmentation/00110_output.png)
![output](examples/segmentation/00017.jpg)
![output](examples/segmentation/00017_mask.png)
![output](examples/segmentation/00017_output.png)
![output](examples/segmentation/00768.jpg)
![output](examples/segmentation/00768_mask.png)
![output](examples/segmentation/00768_output.png)

![output](examples/segmentation/02630.png)
![output](examples/segmentation/02630_mask.png)
![output](examples/segmentation/02630_output.png)


Multiple styles can be transferred to the foreground and background of the content image.

![output](examples/segmentation/02390.jpg)
![output](examples/segmentation/basquiat.png)
![output](examples/segmentation/frida.png)
![output](examples/segmentation/02390_mask.png)
![output](examples/segmentation/02390_mask_inv.png)
![output](examples/segmentation/02390_output.png)

![output](examples/segmentation/02270.jpg)
![output](examples/segmentation/okeffe_red_canna.png)
![output](examples/segmentation/okeffe_iris.png)
![output](examples/segmentation/02270_mask_face.png)
![output](examples/segmentation/02270_mask_face_inv.png)
![output](examples/segmentation/02270_output.png)
...
![output](examples/video/input.gif)
![output](examples/video/opt_flow.gif)
![output](examples/video/weights.gif)
![output](examples/video/output.gif)
...
![output](examples/initialization/init_content.png)
![output](examples/initialization/init_style.png)
![output](examples/initialization/init_random_1.png)
![output](examples/initialization/init_random_2.png)
![output](examples/initialization/init_random_3.png)
![output](examples/initialization/init_random_4.png)
...
![output](examples/layers/conv1_1_1e5.png)
![output](examples/layers/conv1_1_1e4.png)
![output](examples/layers/conv1_1_1e3.png)
![output](examples/layers/conv1_1_1e2.png)
...
![output](examples/layers/conv2_1_1e5.png)
![output](examples/layers/conv2_1_1e4.png)
![output](examples/layers/conv2_1_1e3.png)
![output](examples/layers/conv2_1_1e2.png)
...
![output](examples/layers/conv3_1_1e5.png)
![output](examples/layers/conv3_1_1e4.png)
![output](examples/layers/conv3_1_1e3.png)
![output](examples/layers/conv3_1_1e2.png)
...
![output](examples/layers/conv4_1_1e5.png)
![output](examples/layers/conv4_1_1e4.png)
![output](examples/layers/conv4_1_1e3.png)
![output](examples/layers/conv4_1_1e2.png)
...
![output](examples/layers/conv5_1_1e5.png)
![output](examples/layers/conv5_1_1e4.png)
![output](examples/layers/conv5_1_1e3.png)
![output](examples/layers/conv5_1_1e2.png)
