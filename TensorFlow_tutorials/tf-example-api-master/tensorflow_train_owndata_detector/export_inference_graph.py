...
# 固化参数
pipeline_config_path = 'my_data/faster_rcnn_inception_v2_coco.config'
trained_checkpoint_prefix = 'own_datasets_train_model_output/model.ckpt-14771'
output_directory = 'own_datasets_train_model_output/'
