...
flags.DEFINE_string('checkpoint_dir', 'own_datasets_train_model_output',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', 'own_datasets_train_model_output/evaluation',
                    'Directory to write eval summaries to.')
flags.DEFINE_string('pipeline_config_path', 'my_data/faster_rcnn_inception_v2_coco.config',
