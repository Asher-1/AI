...
# 获取GRUCell网络结构
def grucell():
    # GRUCell网络和LSTMCell网络效果差不多，但GRUCell网络运行更快，故这里选用GRUCell网络
...
with tf.Session() as sess:
    ...
    for i, batch in enumerate(batches):
        ...
        if i % FLAGS.evaluate_every == 0:
            ...
            print("time: {}, Iter {}, loss {:.5f}, train_acc {:.5f}, test_acc {:.5f}, lr {:.5f}".format(
                datetime.now(), i, _loss, tr_acc, ts_acc, learning_rate))
...
# 训练模型可视化： tensorboard --logdir=sounds_models