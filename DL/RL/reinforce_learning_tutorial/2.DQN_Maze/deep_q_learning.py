...
LOG_PATH = "D:/develop/workstations/GitHub/Datasets/DL/trained_outputs/DQN_output/"
...
class DeepQLearning:
    def __init__(
        ...
        self.replace_target_iter = replace_target_iter  # 每多少步迭代替换一下 target 网络的参数
        ...
        if output_graph:
            # 输出 TensorBoard 日志文件
            tf.summary.FileWriter(LOG_PATH + "logs", self.sess.graph)
