...
def learn(env,
  ...
  """
    ...
    def make_obs_ph(name):
        return U2.BatchInput((1, 64, 64), name=name)
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for t in range(max_timesteps):
            ...
            screen = np.array(screen)[None]
            action = act(np.expand_dims(screen, axis=0), update_eps=update_eps, **kwargs)[0]
            reset = False
            rew = 0
            new_action = None
            ...
            if done and print_freq is not None and num_episodes % print_freq == 0:
                print('steps:{}\tepisodes:{}\treward:{}\tmean_100_'
                      'episode_reward:{}\ttime spent exploring:{}'.format(t, num_episodes, reward, mean_100ep_reward,
