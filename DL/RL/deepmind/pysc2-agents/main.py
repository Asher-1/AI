...
ROOT_PATH = 'D:/develop/workstations/GitHub/Datasets/RL/pysc2_agents/'
PATH_TO_MODEL = ROOT_PATH + "snapshot/"
...
flags.DEFINE_string("snapshot_path", PATH_TO_MODEL, "Path for snapshot.")
flags.DEFINE_string("log_path", PATH_TO_LOG, "Path for log.")
...
def run_thread(agent, map_name, visualize):
    with sc2_env.SC2Env(
            ...
            game_steps_per_episode=steps * FLAGS.step_mul) as env:
...
def _main(unused_argv):
    ...
    if not FLAGS.training or FLAGS.continuation:
        ...
        try:
            ...
            print('load model file failed: {}'.format(e))
