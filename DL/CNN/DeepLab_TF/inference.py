...
NUM_CLASSES = 21
ROOT_PATH = 'D:/develop/workstations/GitHub/Datasets/pretrained_models/deeplab_resnet_models/'
SAVE_DIR = './output/'
IMAGE_PATH = './test_images/res25.png'
RESTORE_FROM = ROOT_PATH + 'deeplab_resnet.ckpt'
